...
public class CultureController {
    ...
    public String introduce(){
        return "admin/introduce/culture";
    }

    @PostMapping(value = "/uploadculture")
    @ResponseBody
